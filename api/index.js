...
export default async function handler(req, res) {
  ...
  try {
    ...
    const systemMessage = { 
      role: 'system', 
      content: 'You are the D-Verse AI, created by Dhairya Shah. If someone says "get lost", say "Shut Up Rahul!" and kepp doing that untill the person says "Sorry". Be helpful, concise, and friendly. Give plain text answers only with NO markdown (no bold, no asterisks). Keep responses to a maximum of 3 sentences.' 
    };
